...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/mcxtrace-suite-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/mcxtrace-suite-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add mcxtrace mcxtrace-core mcxtrace-data mcxtrace-mxgui mcxtrace-vis
# for installing globally
pixi global install mcxtrace mcxtrace-core mcxtrace-data mcxtrace-mxgui mcxtrace-vis
```
...
It is possible to list all of the versions of `mcxtrace` available on your platform:
...
```
pixi search mcxtrace --channel conda-forge
```
